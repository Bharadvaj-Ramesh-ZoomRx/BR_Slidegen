...
# Registry path
REGISTRY_PATH = r"C:\Users\SriramSubramanian\Downloads\Claude Experiment\slide_registry.json"
...
def callout_box(slide, left, top, width, height, text=None,
    ...
    if fill_color is None:
        r = int(border_color.red   * 0.12 + 0xFF * 0.88)
        g = int(border_color.green * 0.12 + 0xFF * 0.88)
        b = int(border_color.blue  * 0.12 + 0xFF * 0.88)
