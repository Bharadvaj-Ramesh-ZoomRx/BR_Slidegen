...
| **Segment cuts** | Which splits are needed (e.g., Practice Setting, QoQ, HII vs Others) |
| **Flags** | ⚠️ METHODOLOGY ARTIFACT and/or [ACTION ITEM] if present |
...
- Identify the **primary chart or table type** — based on question code and data type (e.g., horizontal bar / stacked bar / scatter / table)
- List **question codes with text** — from Survey Context
- List **segment cuts** needed
- Write a **narrative arc** — one sentence: what the slide should conclude if the hypotheses hold
...
⚠️ METHODOLOGY ARTIFACT — [brief description] [only if applicable]
