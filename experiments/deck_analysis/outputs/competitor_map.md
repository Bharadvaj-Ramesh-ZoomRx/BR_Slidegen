...
| **UPLIZNA** | AMGEN | 0.08 | color=loose (57), candidate_rank=primary, ta_overlap=0.0, minor_freq=60% (6/10) |
...
| Candidate | Client | Score | Reason |
|---|---|---|---|
| **TRUQAP** | AZN | 0.63 | color=exact, candidate_rank=primary, ta_overlap=0.5, minor_freq=40% (4/10) |
| **ENHERTU** | DSI_AZN | 0.49 | color=near (29), candidate_rank=primary, ta_overlap=0.5, minor_freq=90% (9/10) |
| **JEMPERLI-ZEJULA** | GSK | 0.28 | color=loose (52), candidate_rank=primary, ta_overlap=0.5, minor_freq=70% (7/10) |
...
| Candidate | Client | Score | Reason |
|---|---|---|---|
| **ENHERTU** | DSI_AZN | 0.28 | color=loose (59), candidate_rank=primary, ta_overlap=0.5, minor_freq=80% (8/10) |
| **BLENREP** | GSK | 0.28 | color=loose (56), candidate_rank=primary, ta_overlap=0.5, minor_freq=70% (7/10) |
...
| **DATROWAY** | DSI | 0.15 | color=near (23), candidate_rank=secondary, ta_overlap=0.5, minor_freq=10% (1/10) |
...
| **DATROWAY** | DSI | 0.08 | color=loose (54), candidate_rank=primary, ta_overlap=0.0, minor_freq=80% (8/10) |
